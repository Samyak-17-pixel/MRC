...
OUT = "/home/samyak/mrc_ws/results/iod_strength"
...
for region, file in CATALOGUES.items():
    ...
    # Duration boxplot by strength (non-neutral categories with events)
    ...
    if len(strength_with_events) >= 2:
        ...
        # Kruskal-Wallis across strength categories with enough data
