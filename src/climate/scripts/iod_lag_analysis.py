...
Input:
    data/raw/dmi.had.long.nc
    outputs/mhw/catalogue/*_mhw_catalogue.csv
...
DMI_FILE = "/home/samyak/mrc_ws/data/raw/dmi.had.long.nc"
CATALOGUES = {
...
OUTDIR = Path("/home/samyak/mrc_ws/outputs/iod/lag")
