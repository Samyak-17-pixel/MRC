...
for region in regions:
    ...
    wind = pd.read_csv(
        f"/home/samyak/mrc_ws/outputs/timeseries/{region}_wind.csv"
    )
    ...
    mhw = pd.read_csv(
        f"/home/samyak/mrc_ws/outputs/mhw/catalogue/{region}_mhw_catalogue.csv"
    )
